...
const graphWidth = 70 // gone soon
const graphX = 0.5 * (100 - graphWidth) // gone soon
const boxWidth = 30
const boxSeparation = 20
const boxHeight = 30
const boxX1 = 0.5 * (100 - 2 * boxWidth - boxSeparation)
const boxX2 = boxX1 + boxWidth + boxSeparation
const lineY1 = -90
const lineY2 = -65
